    ...
    def login_page(self):
        ...
        if self.first_run:
            ...
            button_login = CTkButton(login_register_box, text="Login",fg_color='#2B70C9',font=self.font(18),hover_color='grey30', 
                                        command=  lambda: self.controller.show_frame(StartPage),height=50,width=400)
...
class StartPage(ctk.CTkFrame):
    ...
    def dashboard(self) :
        ...
        dashboard_title_1 = CTkLabel(self.box,text='Service Menu',text_color="grey20",font=('Arial Bold',20))
        dashboard_title_1.place(relx=0.31, rely= 0.09, anchor=NE)
    ...
    def responder_status(self):
        ...
        name = CTkLabel(responder_profile_box,text="Name",font=('Arial',14),
                             text_color='grey40')
        ...
        name = CTkLabel(responder_profile_box,text="Division",font=('Arial',14),
                             text_color='grey40')
    ...
    def sidebar(self): 
        sidebar_bg = CTkLabel(self.box,height=790,width=300,fg_color='#642424',corner_radius=18,text='')
        sidebar_bg.place(relx=0.19,rely=0.5,anchor=E)

        logo_directory = os.path.join(self.script_dir, 'assets', 'App_logo.png')
        logo = CTkImage(light_image=Image.open(logo_directory), size=(230,95))
        logo_placeholder = CTkButton(sidebar_bg,image=logo,fg_color='transparent',text='',state="diabled" ,border_width=0,border_color="white")
        logo_placeholder.place(relx=0.55,rely=0.03,anchor=N)
